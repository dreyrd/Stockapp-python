...
from api.v1.services.random_forest_service import RandomForestPrediction
...
async def random_forest_prediction(stock_lag: PredictionCreateBase):
    try:
        random_forest_model = RandomForestPrediction()
